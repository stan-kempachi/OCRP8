...
/**
 * Adds support for the `\p{L}` or `\p{Letter}` Unicode category_tags2. Addon packages for other Unicode
...
/* Adds data for the Unicode `Letter` category_tags2. Addon packages include other categories, scripts,
